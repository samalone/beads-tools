...
#
# Bundled in the beads-tools plugin and auto-registered via hooks/hooks.json, so
# it activates on every machine where the plugin is installed — no per-machine
